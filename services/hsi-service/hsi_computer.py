...
def compute_trend(
    ...
    current_time = datetime.fromisoformat(current_measurement["timestamp"].replace('Z', '+00:00'))
    previous_time = datetime.fromisoformat(previous_measurement["timestamp"].replace('Z', '+00:00'))
