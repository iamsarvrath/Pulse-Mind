...
def process_signal():
    ...
    if "signal" not in data:
        ...
        return (
            jsonify({"success": False, "error": "Missing required field: 'signal'"}),
            400,
        )
    ...
    if "sampling_rate" not in data:
        ...
        return (
            jsonify(
                {"success": False, "error": "Missing required field: 'sampling_rate'"}
            ),
            400,
        )
    ...
    if not isinstance(signal_array, list):
        ...
        return (
            jsonify({"success": False, "error": "Field 'signal' must be an array"}),
            400,
        )
    ...
    try:
        ...
        return (
            jsonify(
                {"success": False, "error": "Field 'sampling_rate' must be a number"}
            ),
            400,
        )
