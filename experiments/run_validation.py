    ...
    try:
        ...
        try:
            resp_ai = requests.post(
                f"{SERVICES['ai']}/predict", json={"features": features}, timeout=5
            )
        ...
        if ai_data.get("success"):
            ...
            print(
                f"AI Prediction: {rhythm_data['rhythm_class']} "
                f"(Conf: {rhythm_data['confidence']:.2f})"
            )
        else:
        ...
        print(
            f"Control Decision: Pacing={pacing.get('pacing_enabled')} "
